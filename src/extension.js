...
function activate(context) {
	...
	// Register the command with the updated name "Dev.start"
	context.subscriptions.push(vscode.commands.registerCommand('Dev.start', () => {
...
function getWebviewContent(extensionUri, currentPanel) {
	const mainUri = currentPanel.webview.asWebviewUri(
